$(document).ready(function(){
  ...
  $('.navigationsectors li').click(function() {
  var tab_id = $(this).attr('data-tab');
    $(this).closest('.wrap').find('ul.navigationsectors li').removeClass('current');
  ...
  $('.navigationsectors li').click(function() {
  var tab_id = $(this).attr('data-tab');
    $(this).closest('.wrap2').find('ul.navigationsectors li').removeClass('current');
