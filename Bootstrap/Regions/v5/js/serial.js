(function() {
    ...
    e.AmRectangularChart = e.Class({
        ...
        drawPlotArea: function() {
            ...
            f.translate(c + a, d + b);
            this.set.push(f);
            0 !== a && 0 !== b && (f = this.plotAreaFillColors, "object" == typeof f && (f = f[0]), f = e.adjustLuminosity(f, -.15), g = e.polygon(this.container, [0, a, g + a, g, 0], [0, b, b, 0, 0], f, l, 1, k, m), e.setCN(this, g, "plot-area-bottom"), g.translate(c, d + h), this.set.push(g), a = e.polygon(this.container,
                [0, 0, a, a, 0], [0, h, h + b, b, 0], f, l, 1, k, m), e.setCN(this, a, "plot-area-left"), a.translate(c, d), this.set.push(a));
...
(function() {
    ...
    e.AmSerialChart = e.Class({
            ...
            if (!this.wheelBusy) {
                ...
                if (l)
                    if (l.mouseIsOver()) {
                        var k = l.mouseX,
                            l = l.mouseY;
                        e != f && (k = this.rotate ? l / this.plotAreaHeight : k / this.plotAreaWidth,
                            e *= k, f *= 1 - k);
        ...
        cleanChart: function() {
            e.callMethod("destroy", [this.valueAxes, this.graphs, this.categoryAxis, this.chartScrollbar,
                this.chartCursor, this.valueScrollbar
            ])
        },
        ...
        getStartTime: function(a) {
            ...
            return e.resetDateToMin(new Date(a),
                b.minPeriod, 1, b.firstDayOfWeek).getTime()
        },
        ...
        updateMargins: function() {
            ...
            if (a = this.valueScrollbar) this.getScrollbarPosition(a, !this.rotate, this.valueAxes[0].position), this.adjustMargins(a,
                !this.rotate)
        },
        updateScrollbars: function() {
        ...
        timeZoom: function(a, b) {
            ...
            isNaN(c) || (b !=
                this.endTime && b - a > c && (a = b - c), a != this.startTime && b - a > c && (b = a + c));
        ...
        formatPeriodString: function(a, b) {
            if (b) {
                ...
                for (var l = 0; l < c.length; l++) {
                    ...
                    a = e.formatValue(a, m, d, f, k + "\\.", this.usePrefixes, this.prefixesOfSmallNumbers,
                ...
                if (void 0 !== a) {
                    if (-1 != a.indexOf("[[category]]")) {
                        ...
                        if (this.categoryAxis.parseDates) {
                            ...
                            h = e.formatDate(g, h, this); - 1 != h.indexOf("fff") && (h = e.formatMilliseconds(h,
                                g));
                            g = h
                        }
                    ...
                    "date" == h.type && (h = e.formatDate(new Date(b.values.value), d.dateFormat, this), f = RegExp("\\[\\[value\\]\\]", "g"), a = a.replace(f, h), h = e.formatDate(new Date(b.values.open), d.dateFormat, this), f = RegExp("\\[\\[open\\]\\]",
                        "g"), a = a.replace(f, h));
        ...
        updateChartCursor: function() {
            ...
            if (a) {
                ...
                if (a.valueLineBalloonEnabled)
                    for (l = 0; l < this.valueAxes.length; l++) h = this.valueAxes[l], (f = h.balloon) || (f = {}), f = e.extend(f, this.balloon, !0), f.fillColor = d, f.balloonColor = d, f.fillAlpha = c, f.borderColor =
                        d, f.color = g, h.balloon = f;
                else
        ...
        handleCursorZoomReal: function(a, b, c, d, e) {
            var h = e.target,
                f, l;
            this.rotate ? (isNaN(a) || isNaN(b) || this.relativeZoomValueAxes(this.valueAxes, a, b) && this.updateAfterValueZoom(), h.vZoomEnabled && (f = e.start, l = e.end)) : (isNaN(c) || isNaN(d) || this.relativeZoomValueAxes(this.valueAxes,
                c, d) && this.updateAfterValueZoom(), h.hZoomEnabled && (f = e.start, l = e.end));
                    ...
                    if (g = this.chartData[g]) {
                        ...
                        if (this.prevCursorItem != g || k != this.prevMostCloseGraph) {
                            ...
                            for (h = 0; h < d.length; h++) {
                                ...
                                }))) : (f.currentDataItem = l, f.resizeBullet(l, b.graphBulletSize,
                                    b.graphBulletAlpha))
                            }
        ...
        handleCursorPanning: function(a) {
            ...
            if (b.zoomable && (0 < Math.abs(d) || 0 < Math.abs(h)))
                ...
                } else if (f = this.start0, g = this.end0, c = g - f, d = Math.round(c * d), h = Math.round(c * h), k = this.chartData.length - 1, a ||
                (c = 0), a = e.fitToBounds(f - d, 0, k - c), c = e.fitToBounds(g - h, c, k), this.start != a || this.end != c) this.skipZoomed = !0, b.fire({
                chart: this,
                target: b,
                type: "zoomed",
                start: a,
    ...
    e.CategoryAxis = e.Class({
        ...
        draw: function() {
            ...
            if (e.ifArray(a)) {
                ...
                for (b = 0; b < y; b++)
                    if (k = this.guides[b], q = q = q = r = d = NaN, m = k.above, k.toCategory && (q = c.getCategoryIndexByValue(k.toCategory),
                        ...
                        q && (d = new this.guideFillRenderer(this, r, d, k), r = d.graphics(), this.pushAxisItem(d, m), k.graphics = r, r.index = b, this.addEventListeners(r,
                            k))
        ...
        xToIndex: function(a) {
            ...
            var l;
            b[h] && (l = b[h].x[this.id]);
            d ? l > this.height + 1 && h-- : l > this.width + 1 &&
                h--;
            0 > l && h++;
